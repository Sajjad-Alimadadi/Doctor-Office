            ...
            <div class="container-xl px-4 mt-4 is-rtl">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <div class="card h-100 border-start-lg border-start-primary">
                                    <div class="card-body">
                                        ...
                                        <input type="file" name="upload-pic" id="upload-pic" style="display:none;">
                                        ...
                                        <form class="mb-3" action="/visit-image/create/{{ request()->route('visit_id')  }}"
                                            ...
                                            <input class="btn btn-primary" name="image" type="file">
                                            <button class="btn btn-primary" type="submit">آپلود</button>
                                        </form>

                                        @if (session()->has('CreateVisitImageResult') )
                                            <div class="alert alert-success alert-solid mt-3"
                                                 role="alert">{{ session('CreateVisitImageResult') }}</div>
                                            @php
                                                session()->forget('CreateVisitImageResult');
                                            @endphp
                                        @endif
                        ...
                        <table id="datatablesSimple">
                            ...
                            @if ($result)
                                @foreach($result as $item)
                                    <tr>
                                        <td><a download="{{ $item['image'] }}"
                                               href="{{ '/visit-image/'.$item['image'] }}"
                                               class="badge bg-primary text-white rounded-pill">دانلود</a></td>
                                        <td><a href="{{ 'delete/'.$item['id'] }}"
                                               class="badge bg-danger text-white rounded-pill">حذف</a></td>
                                    </tr>
                                @endforeach
                            @endif
                            </tbody>
                        ...
                        <div class="card card-icon mb-4 mt-4">
                            <div class="row g-0">
                                <div class="col-auto card-icon-aside bg-secondary"><i class="me-1 text-white-50 fab fa-send"></i></div>
                                <div class="col">
                                    <div class="card-body py-5">
                                        <h5 class="card-title">ارسال پیامکی</h5>
                                        <p class="card-text">
