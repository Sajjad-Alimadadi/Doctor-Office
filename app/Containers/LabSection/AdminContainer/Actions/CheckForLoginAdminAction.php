...
use App\Containers\LabSection\AdminContainer\Tasks\CheckForLoginAdminTask;
use App\Containers\LabSection\DoctorContainer\Tasks\CheckForLoginDoctorTask;
use App\Ship\Parents\Actions\Action as ParentAction;

class CheckForLoginAdminAction extends ParentAction
{
    ...
    public function run(array $data): int|bool
    {
        ...
        return app(CheckForLoginAdminTask::class)->run($data);
    }
}
