                                ...
                                <div class="card h-100 border-start-lg border-start-primary">
                                    <div class="card-body">
                                        ...
                                        <form action="/admin/news/create" method="post">
                                            ...
                                            <div class="mb-3">
                                                <label class="small mb-1" for="title">عنوان خبر</label>
                                                <input class="form-control w-50" name="title" type="input"
                                                       value="{{old('title')}}"/>
                                            </div>

                                            <div class="mb-3">
                                                <label class="small mb-1" for="file">متن خبر</label>
                                                <textarea class="form-control w-100" name="body" ></textarea>
                                            </div>
                            ...
                            @if ($result)
                                @foreach($result as $item)
                                    <tr>
                                        <td>{{ $item['title'] }}</td>
                                        <td>{{ $item['body'] }}</td>
                                        <td><a href="/admin/news/delete/{{ $item['id'] }}"
