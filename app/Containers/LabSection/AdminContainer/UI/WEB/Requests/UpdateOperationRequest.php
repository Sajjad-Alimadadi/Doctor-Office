...
class UpdateOperationRequest extends ParentRequest
{
    /**
...
//        'roles' => '',
    ...
    public function rules(): array
    {
        return [
            '_token'       => 'nullable',
            'id'           => 'nullable',
            'mobile'       => 'nullable|string|min:11|max:11|unique:operations',
            'nationalcode' => 'nullable|string|min:10|max:10|unique:operations',
