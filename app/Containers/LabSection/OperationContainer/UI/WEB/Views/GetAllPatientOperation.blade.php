                            ...
                            @if ($result)
                                @foreach($result as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item['mobile'] }}</td>
                                        <td>
                                            <button class="btn btn-sm btn-primary" type="button" onclick='myFunction("{{$item['id']}}","{{$item['nationalcode']}}","{{$item['name']}}","{{$item['family']}}","{{$item['mobile']}}","{{$item['birthday']}}")' data-bs-toggle="modal" data-bs-target="#exampleModal">ویرایش</button>
                                            <a href="/operation/patient/get/delete/{{ $item['id'] }}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="formAuthentication" action="/operation/patient/update" method="post">
...
<script>
    ...
    function myFunction(id,nationalcode, name, family, mobile, birthday) {
        setTimeout(edit(id,nationalcode, name, family, mobile, birthday), 1000);
    }

    function edit(id,nationalcode, name, family, mobile, birthday) {
